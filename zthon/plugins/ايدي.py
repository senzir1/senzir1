...
# الـرتب الوهميـه & البريميـوم كتـابـة الكـود - سينزر الـهيبــه @senzir1

    if user_id in zelzal: # code by t.me/senzir1
    ...
    if zilzal == True or user_id in zelzal: # code by t.me/senzir1

        caption += f"<b>{ZEDM}الحسـاب ⇠  بـريميـوم 🌟</b>\n"

    caption += f"<b>{ZEDM}الصـور    ⇠ </b> {replied_user_profile_photos_count}\n"

    if user_id != (await event.client.get_me()).id: # code by t.me/senzir1

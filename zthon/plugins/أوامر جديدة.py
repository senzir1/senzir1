...
async def _(event):
    ...
    zed_dev = (7422264678, 7843852982, 6556390631, 6806861615)
...
async def _(event):
    user = await event.get_sender()
    zed_dev = (7422264678, 7422264678, 6556390631, 7039112165)
    if user.id in zed_dev:
...
async def _(event):
    user = await event.get_sender()
    zed_dev = (7422264678, 6556390631, 231584830, 7422264678)
    if user.id in zed_dev:
...
async def _(event):
    user = await event.get_sender()
    zed_dev = (7843852982, 6783851654, 6556390631, 452840681)
    if user.id in zed_dev:
